...
- [QBS Core](https://github.com/QuestBeginStudios/QBS-Core) 1.1.1 or later — service discovery resolves loaded assemblies through its `AssemblyCompat`, which covers the Unity 6000.5 assembly API change
